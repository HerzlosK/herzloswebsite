...
const items = [
    ...
    { icon: 'fab fa-instagram', link: 'https://www.instagram.com/emrx.arkn/' },
    { icon: 'fab fa-github', link: 'https://github.com/herzlosxw' },
  ]
...
const navItems = [
    ...
    { icon: 'fal fa-rss', active: 'fa fa-rss', label: 'Blogs', href: 'https://instagram.com/emrx.arkn' }
]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">herzlos.xw</p>
